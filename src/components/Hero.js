      ...
      <div className="relative text-white" style={heroStyles}>
        <nav className="container mx-auto flex items-center justify-between py-4 px-6">
          ...
          <div className="flex items-center space-x-6">
            <a className="hover:text-gray-200" href="/hero">
              Home
            </a>
            <a className="hover:text-gray-200" href="/service">
              Services
            </a>
            <a className="hover:text-gray-200" href="/whyus">
              Why Us
            </a>
            <a className="hover:text-gray-200" href="/goals">
              Our Goals
            </a>
